...
int 
_ether_memory_init(unsigned int maxmem)
{
...
void *
_ether_memory_mark(void)
{
	return _ether_memory_our_highwater;
}

void 
_ether_memory_release(void *ptr)
{
