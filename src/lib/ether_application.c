...
void 
ether_application_draw_under(void)
{
}

void
ether_application_draw_over(EtherRenderStatus *stat)
{
#if 0
...
void
ether_application_key(unsigned int key)
{
}

void
ether_application_mouse_up(int x, int y, unsigned int buttons)
{
}

static int 
_ether_application_object_move_locally(EtherObject *obj)
{
	return -1;
}
