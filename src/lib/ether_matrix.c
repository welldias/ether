...
{
  double m00 = ETHER_FACTOR_TO_FLOAT(m[0][0]);
  double m01 = ETHER_FACTOR_TO_FLOAT(m[0][1]);
  double m10 = ETHER_FACTOR_TO_FLOAT(m[1][0]);
  double m11 = ETHER_FACTOR_TO_FLOAT(m[1][1]);
  double m20 = ETHER_FACTOR_TO_FLOAT(m[2][0]);
  double m21 = ETHER_FACTOR_TO_FLOAT(m[2][1]);
  double m22 = ETHER_FACTOR_TO_FLOAT(m[2][2]);
